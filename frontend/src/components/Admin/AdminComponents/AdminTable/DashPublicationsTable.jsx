...
const DashPublicationsTable = ({ data }) => {
  ...
  return (
    <div className="publications__table">
      <div className="flex items-center justify-between gap-3 px-3 py-2 lg:px-5 lg:py-3">
        <p className="hidden text-lg font-semibold text-[#1d1d1d] sm:block md:text-lg">
          Publications List
        </p>
...
export default DashPublicationsTable;
